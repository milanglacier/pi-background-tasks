...
describe("background task shared helpers", () => {
	...
	it("builds temp log paths and output tails", () => {
		expect(getBgProcessLogFilePath(123, "C:/Temp", "bg-1")).toBe(join("C:/Temp", "milanglacier-bg-bg-1-123.log"));
		expect(getBgProcessLogFilePath(123, "/tmp", " ### ")).toBe(join("/tmp", "milanglacier-bg-123.log"));
